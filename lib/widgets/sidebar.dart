                          ...
                          Expanded(
                            child: Material(
                              ...
                              child: InkWell(
                                borderRadius: BorderRadius.circular(12),
                                splashColor: (isDarkMode ? AppTheme.primaryLightColor : AppTheme.primaryColor).withOpacity(0.1),
                                highlightColor: (isDarkMode ? AppTheme.primaryLightColor : AppTheme.primaryColor).withOpacity(0.05),
                                onTap: () {
                                  // 点击个人信息栏跳转到账户信息页面
                                      ...
                                      return Row(
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: ClipOval(
                                              child: _buildSidebarAvatar(user!, context),
                                            ),
                                          ),
                                          const SizedBox(width: 12),
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  currentUser?.nickname?.isNotEmpty == true ? currentUser!.nickname! : (currentUser?.username ?? ''),
                                                  style: TextStyle(
                                                    fontSize: 16,
                                                    fontWeight: FontWeight.w600,
