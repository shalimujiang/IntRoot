...
class _ImportExportScreenState extends State<ImportExportScreen> with SingleTickerProviderStateMixin {
  ...
  // Android优化的文件保存方法
  Future<void> _saveFileWithAndroidOptimization(String fileName, Uint8List fileBytes, int notesCount) async {
    try {
  ...
  // 保存到应用私有目录
  Future<void> _saveToAppPrivateDirectory(String fileName, Uint8List fileBytes) async {
    try {
      // 获取应用文档目录
